      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <motion.div className="text-center mb-16" variants={itemVariants}>
          ...
          >
            ...
            or aiming to take it to the next level, Health Wellness Nextprovides the tools
        ...
        >
          <h2 className="text-3xl font-semibold text-center text-blue-400 mb-8">
            Key Features of Health Wellness Next
          </h2>
          <motion.ul
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            At Health Wellness Next, our mission is simple: to make fitness accessible,
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Health Wellness Next is here to support you at every stage of your fitness
